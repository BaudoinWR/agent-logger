...
public class ResultSetWrapper implements ResultSet {
  ...
  public ResultSetWrapper(ResultSet wrapped, String statement, Map<Integer, Object> parameters) {
  ...
  public boolean next() throws SQLException {
    ...
    if (next) {
      ...
      for (int i = 1; i <= resultSetMetaData.getColumnCount(); i++) {
        String columnName = i + " - " + resultSetMetaData.getColumnName(i);
        values.put(columnName, this.getObject(i));
      }
      result.add(values);
    }
    return next;
  ...
  private String resultsToString() {
    ...
    for (Map<String, Object> map : result) {
      ...
      for (Map.Entry<String, Object> entry : map.entrySet()) {
        s.append(entry.getKey() != null ? entry.getKey().trim(): "null")
          .append("=")
          .append(entry.getValue() != null ? entry.getValue().toString().trim(): "null")
          .append(";");
      }
